<script>
    ...
    const handleExpenseEdit = (event) => {
        ...
        // Scroll to form
        document
            .querySelector(".bg-white.dark\\:bg-gray-800.rounded-lg.shadow-md")
            .scrollIntoView({
                behavior: "smooth",
            });
    };
    ...
    const handleMonthChange = async (event) => {
        ...
        console.log("Main page: received monthChange", {
            year,
            month,
            currentYear,
            currentMonth,
    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                Built with SvelteKit 5 and Tailwind CSS.
            </p>
        </div>
    </footer>
</div>
